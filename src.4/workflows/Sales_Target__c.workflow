...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>Unique Sales Target Field Change</fullName>
        <actions>
        ...
        <formula>OR( ISCHANGED( Owner__c ) , ISCHANGED( Type__c ) , ISCHANGED( Target_Month__c ) , ISCHANGED( Target_Year__c ) , ISNEW() )</formula>
