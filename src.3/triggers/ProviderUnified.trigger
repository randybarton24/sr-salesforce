trigger ProviderUnified on Provider__c (after delete, after insert, after undelete,
after update, before delete, before insert, before update) {
	...
	ProviderTriggerHandler handler = new ProviderTriggerHandler(Trigger.isExecuting, Trigger.size);
