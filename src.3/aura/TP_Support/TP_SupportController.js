({        
	...
	callLiveAgent : function(component, event, helper) {
        ...
        urlEvent.fire();
        /*window.open("https://home-c4.incontact.com/inContact/ChatClient/ChatClient.aspx?poc=a08bb6bb-30e1-4316-a794-e0c64e2ec1de&bu=4592828",
                    "_blank",
                    "toolbar=no,scrollbars=no,resizable=yes,width=500,height=922");*/
	},
